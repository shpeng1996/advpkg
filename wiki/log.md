...
## [2026-07-12] collect | 每日自動蒐集 — TSMC CoWoS 路線圖基板尺寸補遺（120×150mm/2027）、CoPoS 玻璃臨時載具澄清、NVIDIA Feynman 首發確認
- 搜尋查詢數：7 組（TSMC CoWoS/CoPoS、HBM4/HBM4E、Intel EMIB/Foveros、混合接合、面板封裝FOPLP、UCIe 標準、市場整體）
- 成功抓取：2 篇（存入 raw/articles/ 2 篇）
  - `2026-04-27_tomshardware_tsmc-cowos-14reticle-roadmap-2029.md`（Tom's Hardware，發布 2026-04-27；TSMC North America Symposium 完整路線圖）
  - `2026-06-14_digitaltrends_tsmc-copos-glass-carrier-mingchikuo.md`（Digital Trends/Ming-Chi Kuo，發布 2026-06-14；CoPoS 玻璃角色澄清）
- 失敗/跳過：多篇（SK hynix 美國廠已收錄；SemiWiki CoWoS 原文 2025-08 超過 6 個月；SemiEngineering ECTC 2026 已收錄；其他 URL 付費牆或低相關）
- _collected_urls.txt：261 → 263 行
- 觸發 ingest：2 篇
- 新增 wiki/sources/ 頁：2 頁
  - wiki/sources/2026-04-27_tomshardware_tsmc-cowos-14reticle-roadmap.md（新建）
  - wiki/sources/2026-06-14_digitaltrends_tsmc-copos-glass-temporary-carrier.md（新建）
- 更新 wiki 頁面：5 頁
  - wiki/technologies/cowos.md（補充 9.5× 2027 基板尺寸 120×150mm；修正 14× 2028 compute chiplets 數量為 20）updated→2026-07-12
  - wiki/technologies/copos.md（新增玻璃臨時載具關鍵澄清；NVIDIA Feynman 具名首發；>9.5× 觸發門檻）updated→2026-07-12
  - wiki/entities/nvidia.md（Feynman 封裝欄位補充 CoPoS；CoPoS 首批客戶分析）updated→2026-07-12
  - wiki/entities/tsmc.md（CoWoS 路線圖補充基板尺寸與 compute chiplet 數修正）updated→2026-07-12
  - wiki/index.md（頁面總數 288→290；來源數 249→251；更新時間→2026-07-12；新增 2 筆 sources 連結）
- 主要新知識：
  1. **CoWoS 2027 基板實體尺寸首次入 wiki**：Tom's Hardware 揭露 9.5× reticle CoWoS（2027）基板為 **120mm × 150mm**；2028 年 14× 版本的計算晶片數從模糊的「~10 顆」修正為 **20 顆 3D-stacked compute chiplets**——這是 wiki 中 CoWoS 路線圖量化細節最重要的一次補正。
  2. **CoPoS 玻璃 = 臨時載具（非玻璃核心基板）**：Ming-Chi Kuo 2026-06-11 澄清 CoPoS 製程中的玻璃為暫時性承載介質，製程結束後移除，最終成品仍採傳統有機基板。此澄清消除了 wiki 早期條目因報導模糊引入的誤解，同時釐清 CoPoS 玻璃路線（臨時載具）與玻璃核心基板（TGV 永久結構，~2030+）的根本區別。
  3. **NVIDIA Feynman 具名為 CoPoS 首發客戶**：Ming-Chi Kuo 首次具名 Feynman（2028–2029 量產世代）為 CoPoS 最可能的首批量產客戶——其 3D 堆疊架構使封裝面積超越 9.5× reticle 門檻，自然觸發 CoPoS 路線。與 TSMC 2H28 量產時程高度吻合。
