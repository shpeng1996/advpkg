...
| 指標 | HBM4 | ZAM/HB3DM |
|------|------|-----------|
| 單模組頻寬 | ~2 TB/s | ~5.3 TB/s（估計，171 mm² / 10 GB） |
| 頻寬密度 | — | ~0.25 Tb/s/mm² |
| 能耗 | — | <0.7 pJ/bit |
| 功耗密度 | — | <0.35 W/mm² |
| 堆疊方式 | CoW 微凸塊（MR-MUF） | Fusion-bonded wafer via-last TSV |
| 矽基板厚度 | 30–50 µm | ~3 µm（超薄） |
| 原型時程 | 已量產 | 2027 |
| 量產時程 | 已量產 | 2029 |

**戰略意義**：若 ZAM/HB3DM 2029 年順利量產，提供 >2.5× HBM4 頻寬且能耗顯著降低，將挑戰 HBM4E 和 HBM5 的市場地位。但 2029 量產時程面臨 SK Hynix HBM5 競爭，技術風險和供應商生態繞過 SK Hynix/Samsung 等 HBM 壟斷廠，需要獨立 DRAM 設計能力。

---

## 爭議與未解問題 / Open Questions

- HBM4E 高度規格若放寬至 ~900µm，是否會進一步延後 hybrid bonding 導入？
- Custom base die 是否會成為 HBM4/HBM4E 供應商差異化的主戰場？
- CoWoS 與 EMIB 是否會迫使 HBM 供應商提供封裝平台相容性不同的 SKU？
- 16H HBM4 的 MR-MUF / TCB 良率能否在 2026 H2 達到 NVIDIA Rubin Ultra 所需規模？
