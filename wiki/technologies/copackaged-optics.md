...
- **2026-05-27（⭐最新）**：**NVIDIA Spectrum-X Ethernet Photonics CPO 交換器正式確認出貨並整合進 Vera Rubin NVL72**——NVIDIA COMPUTEX 2026 BCA 確認 NVL72 標配 Spectrum-X CPO 乙太網路光學交換器；NVL72 為「台灣史上最大規模產品發布」（2 百萬零件，150 台灣夥伴）。此為 TSMC COUPE CPO 平台的**商業化量產里程碑**，確認 CPO 從「2026 年量產啟動」進入「大規模客戶出貨」階段。*Source: NVIDIA Blog 2026-05-27*
