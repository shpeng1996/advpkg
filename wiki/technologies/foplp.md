...
AMD 於 COMPUTEX 2026 前夕公開確認：Powertech Technology（PTI）已完成業界首款**面板型（panel-based）2.5D EFB（Elevated Fanout Bridge）互連認證**。EFB 是 Intel EMIB / TSMC CoWoS-L 的競爭替代方案，過去均在矽晶