...
- Absolics（SK Group + Applied Materials JV）2026 量產目標是否能實現？**佐治亞廠已完工（全球首座專用廠），但目前仍在爭取 NVIDIA 等主要 fabless 客戶訂單階段**，量產時程取決於客戶採購決策。
- 供應鏈主導權（設備/材料仍由歐美日掌握）是否因地緣政治影響而重組？**Lens Technology（中國蘋果供應商）宣布進入 TGV 玻璃基板**，中國廠商開始切入。
- Google 和 Microsoft 已將玻璃基板納入硬體設計初期考量——hyperscaler 需求驗證已至，但下單量產時程不確定。

---

## ⭐ 最新動態（2026-03-03 更新）

### SKC/Absolics ₩1T 增資＋雙軌商業化策略
