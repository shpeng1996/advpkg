...
**對封裝供應鏈的影響**：T-glass 布是 AI 伺服器封裝基板（ABF 基板）的核心增強材，供應商高度集中於 Nittobo 的格局正逐步被挑戰。T-glass 短缺（先前 Nittobo 漲價 +20–30%，見 wiki/sources/2026-04-30_trendforce-insights_glass-fiber-cloth-shortage.md）是 AI 伺服器封裝基板成本壓力的上游來源之一。
