...
**⭐ 2026-08-22 新增：美國《國家安全科技策略》（NSSTS 2026-08）明確點名先進封裝**：
白宮 2026 年 8 月發布 National Security Science and Technology Strategy，指示各聯邦機構優先推動以下半導體 R&D：**EDA、先進製造設備與製程、異質整合與先進封裝（Heterogeneous Integration & Advanced Packaging）**、AI/RF/光學硬體、2D 材料、積體光子。這是繼 CHIPS Act 後，美國政策層次最高的先進封裝明確點名，將封裝從產業政策層次提升至國家安全戰略層次。（SemiEngineering Week #152）
...
### ⭐ 2026-09-10 更新：華為 950DT 漲價 50%；CXMT HBM3E 試產；灰市 HBM 成本機制；DeepSeek 16 萬卡訂單

*Sources: [[sources/2026-09-10_trendforce_chinese-ai-chipmakers-hbm-price-hike]]*

**華為 Ascend 950DT 漲價 +50%**：
- 終端售價由 RMB ~170,000 漲至 **>RMB 250,000**（+50%），超越漲價前 H100 國際市場價格
- 漲價驅動：HBM 灰市成本上漲 + AI 晶片需求遠超供給 + Huawei 市占進一步壟斷
- 中國 AI 晶片採購商層級分化：**ByteDance** 第一（確保優先出貨）；**DeepSeek 特殊合作關係**（見下）

**CXMT HBM3E 試產啟動（⭐ 首次確認）**：
- 中國大陸首次本土 HBM3E 試產，已可供樣品
- 規格目標：12-Hi 堆疊，頻寬 ~1.2 TB/s（vs SK Hynix HBM3E 1.2 TB/s 相當）
- 良率、量產化時程尚未揭露；定義為「試產（trial production）」階段而非量產
- **意義**：CXMT 繼 LPDDR6（2026-09）之後，首次確認 HBM3E 技術突破——2026 年下半年 CXMT 成為中國 DRAM 歷史性突破最密集的廠商
- **封裝含義**：HBM 要求 TSV + 混合接合封裝，CXMT 試產成功代表中國本土 HBM 封裝能力（本土 OSAT 或自有設施）已達初步門檻

**Huawei 自有 HBM 命名體系（⭐ 首次確認）**：
- Huawei 使用自有品牌命名 HBM 模組而非 SK Hynix/Micron 型號：
  - **HiBL 1.0**：低頻寬版（HBM3E 8-Hi 等效）
  - **HiZQ 2.0**：高頻寬版（HBM3E 12-Hi 等效，用於 950DT）
- 命名體系類似 Apple 對 TSMC 製程品牌化——隱藏實際供應商並強化「自研」形象
- 此前 wiki 記錄 Huawei 使用灰市 HBM（來源匿名），本次首次確認 Huawei 已建立 HBM 命名規範

**灰市 HBM 成本機制量化**：
- 出口管制（2024-12）後，HBM 灰市溢價約 **+60~80% vs 原廠報價**
- 灰市 HBM 來源鏈：韓國/日本原廠 → 新加坡/台灣中間商 → 中國終端採購商
- 最終 HBM 成本佔 Ascend 950DT 系統 BOM 的 ~35~40%，是漲價最直接的傳導因子

**DeepSeek 16 萬卡 Ascend 950DT 採購（⭐ 首次量化）**：
- DeepSeek 正在建設內蒙古資料中心，目標採購 **160,000 台 Ascend 950DT**（= ~160K GPU 等效）
- 此為迄今為止中國 AI 廠商向 Huawei 最大單筆 AI 晶片採購訂單（可查閱公開報導範圍內）
- 分析：DeepSeek 的模型效率（MoE 稀疏架構）使其能最大化每張卡的利用率；大規模 Ascend 部署反向驗證 Huawei CANN/MindSpore 生態系已達可用門檻
