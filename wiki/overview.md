...
- [ ] **扇出封裝（InFO）** 獨立技術頁面（CoPoS 頁已含 FOPLP 競爭格局；InFO 仍缺獨立頁面）
...
- [ ] **TEL（Tokyo Electron）設備廠商頁面**：封裝設備生態系仍需補充
...
- **頁面總數**：32 頁（實體 8、技術 8、概念 2、來源 11、總覽 1、索引 1、log 1）
- **原始來源數**：12 篇（raw/reports/ 1、raw/articles/ 11）
- **最近操作**：2026-04-25 第二次每日自動 Collect（5 篇新文章，3 個新頁面、6 個既有頁面更新）
