...
- **Micron**：HBM 第三供應商（~10%）
- **Intel**：NVIDIA 評估 Feynman I/O die 採用 Intel 14A/18A，但高端 GPU 封裝因功率限制仍留 TSMC

---

## 爭議與未解問題 / Open Questions

- CoWoS interposer 面積限制（120mm²）是否為 Rubin Ultra 之後的根本性約束？（CoPoS 2028–29 有望解決）
- Feynman 是否真的等待 TSMC 美國廠（2029）？若 TSMC 美國廠延遲，NVIDIA 有何備案？
- NVIDIA Vera CPU 的封裝細節（是否使用 CoWoS 或 SoIC）尚未確認
