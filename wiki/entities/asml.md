...
title: "ASML"
category: entity
tags: [equipment, lithography, EUV, hybrid-bonding, DUV, RDL, advanced-packaging]
created: 2026-05-03
updated: 2026-05-04
sources: [2026-03-23_trendforce_asml-hybrid-bonding-equipment, 2026-01-23_trendforce_chip-tools-tel-asml, 2026-04-23_trendforce_tsmc-roadmap-a12-a13-no-high-na-euv]
related:
...
ASML 在混合接合設備市場目前處於**觀望評估**階段，現有主要競爭者為 EV Group、Besi/ASMPT。若 ASML 的 Maglev 磁浮精密對準技術（< 5nm overlay）應用於混合接合設備，將對 Besi 的市場地位構成顯著威脅。

| 指標 | 數值 |
|------|------|
| Besi Q4 2025 訂單積壓 YoY | +105%（顯示市場吸引力） |
| ASMPT 先進封裝收入佔比 | ~25%（2025 年估） |
| ASML 混合接合進場狀態 | 評估中（非正式啟動） |
| XT:260 3D DUV 出貨時間 | 2025-Q3 |
...
- ASML 混合接合設備研發是否會正式啟動？時程？
- Maglev 技術（~5nm overlay）能否在混合接合市場建立差異化優勢（Besi 現有精度為亞微米級）？
- ASML 進場是否會壓縮 Besi 和 ASMPT 的市場空間？
