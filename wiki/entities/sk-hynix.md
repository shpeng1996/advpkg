...
- **2026-07-14（⭐最新）**：**龍仁 Y1 設備訂購正式啟動，Phase 1 開幕提前至 2027-02**（TrendForce 引述 ZDNet Korea）：SK hynix 已開始下單 Yongin Y1 廠設備，初期目標產能 **~20,000 wsm**，製程節點：1c DRAM（第六代 10nm 級），支援 DDR、LPDDR 及 **HBM4E**。Y1 Phase 1 原計畫 2027-05 開幕，現提前至 **2027-02**（設備安裝斜坡 2027-03~04）。Y1 Phase 2+3 潔淨室建設預計 2H 2026 啟動。龍仁叢集整體完成時程：2033（2026-06-30 首度記錄的 2045→2033 提前，本次確認 Y1 P1 門票時程）。三星龍仁：首座廠 2029（代工，提前自 2030-31）。
