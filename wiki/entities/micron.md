...
- **2026-06-26（⭐最新）**：**Micron Q3 FY26 財報法說會**：12 層 HBM4 量產斜率為 HBM3E 的 **2 倍**，累計出貨已超 **$10 億美元（>$1B）**；AI 需求及結構性產能限制將使記憶體供應緊張**持續至 2027 年以後**；16 個客戶已簽署多年期「take-or-pay」協議（設有價格下限），確保需求鎖定。（出處：SemiEngineering Week #144 2026-06-26）
